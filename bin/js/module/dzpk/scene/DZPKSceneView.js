...
(function (module) {
    ...
    (function (dzpk) {
        ...
        (function (scene) {
            ...
            class DZPKSceneView extends ui.game_dzpk.DZPKSceneUI {
                constructor(vm) {
                    super();
                    this._PLAYER_NUM = 9;
                    this._my_seat = -1;
                ...
                showPlayersCards(list) {
                    ...
                    for (i = 0; i < len; i++) {
                        ...
                        if (c_data["seatNO"] != this._my_seat && c_data["action"] != dzpk.TEXAS_HOLDEM_ACTION.FOLD) {
                ...
                updatePlayerCards(card0, card1, seat, showall = true) {
                    let box_player = this.getPlayerSeat(seat);
                    box_player.getChildByName("box_cards").getChildByName("box_lcard").getChildByName("img_card")["skin"] = core.CFun.format("dzpk/cards/card_{0}.png", dzpk.DZPKCardLogic.ins.cardValuetToClient(card0));
                    box_player.getChildByName("box_cards").getChildByName("box_rcard").getChildByName("img_card")["skin"] = core.CFun.format("dzpk/cards/card_{0}.png", dzpk.DZPKCardLogic.ins.cardValuetToClient(card1));
                    if (seat != this._my_seat) {
                ...
                showPublicCard(cards, start, end, pre_box_card) {
                    ...
                    if (start > end)
                        return;
                    let box_card;
                    var cardData = dzpk.DZPKCardLogic.ins.cardValuetToClient(cards[start]);
                    if (cardData > 0) {
                    ...
                    if (player.chip == 0) {
                        ...
                        switch (action) {
                            ...
                            case dzpk.TEXAS_HOLDEM_ACTION.PASS://过牌
                                ...
                                break;
                            case dzpk.TEXAS_HOLDEM_ACTION.FOLD://弃牌
                ...
                getPlayerSeat(seat) {
                    if (this._my_seat == -1)
                        core.CFun.throw("DZPKSceneView中玩家的索引this._my_index还未确定");
            ...
            scene.DZPKSceneView = DZPKSceneView;
