            ...
            class DZPKEffect extends laya.ui.Component {
                ...
                choumaEffect(p_start, p_end) {
                    ...
                    for (i = 1; i <= len; i++) {
                        ...
                        Laya.Tween.to(chouma, { x: p_end.x, y: p_end.y }, 200, null, Handler.create(this, this.choumaComplete, [chouma]), i * 20);
                    }
                }
                ...
                qipaiEffect(p_start, p_end) {
                    ...
                    this.addChild(cards);
                    Laya.Tween.to(cards, { x: p_end.x, y: p_end.y }, 400, null, Handler.create(this, this.qipaiComplete, [cards]));
                }
                qipaiComplete(cards) {
                ...
                comFanpai(p_pai, p_he, back_complete, args, obj) {
                    ...
                    card.scale(0.3, 0.3);
                    this.addChild(card);
                    Laya.Tween.to(card, { x: p_pai.x, y: p_pai.y }, 200, null, Handler.create(this, this.moveComplete, [card, p_pai, back_complete, args, obj]));
                }
                ...
                heguanfapaiEffect(arr_p, he_p, me_index, me_complete, args, obj) {
                    ...
                    let i = 0, len = arr_p.length;
                    for (i = 0; i < len * 2; i++) {
                        Laya.Tween.to(card, { x: arr_p[i % len].x, y: arr_p[i % len].y }, 200, null, Handler.create(this, this.heguanComplete, [card, he_p, me_index, i, len * 2, me_complete, args, obj]), i * 250);
                    }
                }
