...
(function (core) {
    ...
    ExternalInterfaceUtils._version = "0.0.0.0";
    ExternalInterfaceUtils._MACAddress = "0:0:0:0";
    /*
     *当前界面上是否显示loading
     * */
    ExternalInterfaceUtils.isShowLoading = false;
    /**
     * 获取包名
     */
    ExternalInterfaceUtils.packageName = "null";
    ExternalInterfaceUtils._is_full = false;
    core.ExternalInterfaceUtils = ExternalInterfaceUtils;
})(core || (core = {}));
