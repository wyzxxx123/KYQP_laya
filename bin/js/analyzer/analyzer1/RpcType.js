define(["require", "exports", "./RpcDef"], function (require, exports, RpcDef_1) {
    ...
    var RpcType = /** @class */ (function () {
        ...
        RpcType.arrayWriter = function (data, val) {
            ...
            var writer = RpcDef_1.RpcDef.getTypeWriter(val.$type.name);
            if (writer == null) {
        ...
        RpcType.arrayReader = function (data) {
            ...
            var v = RpcDef_1.RpcDef.newArray(id);
            if (!v) {
                throw new TypeError("Invalid array type id: " + id);
            }
            var len = data.getInt16();
            var reader = RpcDef_1.RpcDef.getTypeReader(v.$type.name);
            if (reader == null) {
        ...
        RpcType.structWriter = function (data, val) {
            ...
            for (var _i = 0, _a = val.$type.fields; _i < _a.length; _i++) {
                var i = _a[_i];
                var writer = RpcDef_1.RpcDef.getTypeWriter(defs[i]);
                if (writer == null) {
        ...
        RpcType.structReader = function (data) {
            var id = data.getInt16();
            var v = RpcDef_1.RpcDef.newStruct(id);
            if (!v) {
            ...
            for (var _i = 0, _a = v.$type.fields; _i < _a.length; _i++) {
                var i = _a[_i];
                var reader = RpcDef_1.RpcDef.getTypeReader(defs[i]);
                if (reader == null) {
