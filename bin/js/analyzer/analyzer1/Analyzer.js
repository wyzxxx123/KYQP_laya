define(["require", "exports", "./RpcDef", "./RpcType", "./crypt/Ctx", "../../core/CFun", "../../core/net/ClassPro"], function (require, exports, RpcDef_1, RpcType_1, Ctx_1, CFun_1, ClassPro_1) {
    "use strict";
    ...
    class Analyzer {
                ...
                if (this._byte.bytesAvailable >= this.INT_SIZE) {
                    if (StaticData.seed > 0) {
                        if (this._encrypter == undefined) {
                            this._encrypter = new Ctx_1.Ctx(StaticData.seed ^ this.GENIUS_NUMBER);
                            this._decrypter = new Ctx_1.Ctx(StaticData.seed ^ this.GENIUS_NUMBER);
                        }
                    ...
                    if (len > this.MAX_LEN) {
                        CFun_1.CFun.throw("packet size exceed: " + len);
                        return null;
                    }
                    this._packetLen = len;
                }
        ...
        analyzeSend(data) {
            ...
            for (let i = 0; i < ilen; i++) {
                ...
                if (writer == null) {
                    CFun_1.CFun.throw("Type writer not found: " + targ.type);
                }
