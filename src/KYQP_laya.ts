...
class GameMain{
    ...
    constructor()
    {
        ...
        Laya.loader.load([  { url: "res/atlas/public.atlas", type: Loader.ATLAS },
                            ...
                            // { url: "res/atlas/dzpk/gameScene.atlas", type: Loader.ATLAS },
                            // { url: "res/atlas/dzpk/zh-cn/font/buttonFont.atlas", type: Loader.ATLAS },
                            // { url: "res/atlas/dzpk/zh-cn/font/operateActionFont.atlas", type: Loader.ATLAS },
                            // { url: "res/atlas/dzpk/zh-cn/font/gameOverFont.atlas", type: Loader.ATLAS },
                            // { url: "res/atlas/dzpk/zh-cn/font/cardTypeFont.atlas", type: Loader.ATLAS },
                            // { url: "res/atlas/dzpk/cards.atlas", type: Loader.ATLAS }
                            ],
    ...
    // private _aa:module.dzpk.scene.DZPKSceneView;
    private _aa:ui.game_dzpk.TestVSUI;
    // private _aa:module.dzpk.scene
